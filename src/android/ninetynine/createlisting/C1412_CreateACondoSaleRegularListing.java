...
public class C1412_CreateACondoSaleRegularListing extends Base_Test {
	...
	@Test
	public void C1412_CreateACondoSaleRegular_Listing() throws Exception {
		...
		System.out.println("\n");
		System.out.println("TestCase : C1412");	
		System.out.println("Create a Condo/Sale regular listing");	
		System.out.println("---------");		 
		...
		if (util.verifyLogin()) {
			 ...
			 try {
					...
					System.out.println("Then my listing should be created for Condo/Sale");
