...
public class C1407_CreateACondoRentRegularListing extends Base_Test {
	...
	@Test
	public void C1407_CreateACondoRentRegular_Listing() throws Exception {
		...
		System.out.println("\n");
		System.out.println("TestCase : C1407");	
		System.out.println("Create a Condo/Rent regular listing");	
		System.out.println("---------");		 
		...
		if (util.verifyLogin()) {
			 ...
			 try {
					...
					System.out.println("Then my listing should be created for Condo/Rent");
