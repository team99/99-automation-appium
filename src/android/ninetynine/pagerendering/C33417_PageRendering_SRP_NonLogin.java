...
public class C33417_PageRendering_SRP_NonLogin extends Base_Test {
	...
	@Test
	public void C33417_PageRendering_SRP_Non_Login() throws Exception {
		...
		srpae = new SRP_AssertEqual(driver);
		 ...
		 System.out.println("=========");
		 System.out.println("TestCase : C33417");	
		 System.out.println("Page Rendering SRP - Non login");	
		 System.out.println("---------");		 
