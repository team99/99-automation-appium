...
public class C33416_PageRendering_LDP_Reg_LoginAgent extends Base_Test {
	...
	@Test
	public void C33416_PageRendering_LDP_Reg_Login_Agent() throws Exception {
		...
		ldpae = new LDP_AssertEqual(driver);
		 ...
		 System.out.println("=========");
		 System.out.println("TestCase : C33416");	
		 System.out.println("Page Rendering LDP - Agent user");	
		 System.out.println("---------");		 
