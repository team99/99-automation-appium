...
public class C33411_PageRendering_LDP_MustSee_LoginVer extends Base_Test {
	...
	@Test
	public void C33411_PageRendering_LDP_MustSee_Login_Ver() throws Exception {
		...
		ldpae = new LDP_AssertEqual(driver);
		 ...
		 System.out.println("=========");
		 System.out.println("TestCase : C33411");	
		 System.out.println("Page Rendering LDP - Verified user");	
		 System.out.println("---------");		 
