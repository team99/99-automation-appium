...
public class C33415_PageRendering_LDP_Reg_LoginVer extends Base_Test {
	...
	public void C33415_PageRendering_LDP_Reg_Login_Ver() throws Exception {
		...
		ldpae = new LDP_AssertEqual(driver);
		 ...
		 System.out.println("=========");
		 System.out.println("TestCase : C33415");	
		 System.out.println("Page Rendering LDP Regular - Verified user");	
		 System.out.println("---------");		 
