...
public class C33418_PageRendering_SRP_LoginUnver extends Base_Test {
	...
	public void C33418_PageRendering_SRP_Login_Unver() throws Exception {
		...
		srpae = new SRP_AssertEqual(driver);
		 ...
		 System.out.println("=========");
		 System.out.println("TestCase : C33418");	
		 System.out.println("Page Rendering SRP - Unverified user");	
		 System.out.println("---------");		 
		...
		if (util.verifyLogin()) {	
			 ...
			 try {
					...
					System.out.println("State : Saved search button displayed as expected");
			    ...
			    //This method for check if the filter search button is displayed
						 try {
								...
								System.out.println("State : Filter search button displayed as expected");
								
							} catch (Exception e){
										
								System.out.println("State : Filter search button Not Shown as expected");
