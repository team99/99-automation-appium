...
public class C33421_PageRendering_CreateListing_MustSee extends Base_Test {
	...
	public void  C20_PageRendering_CreateListing_MustSee() throws Exception {
		...
		clae = new CreateListing_AssertEqual(driver);
		 ...
		 System.out.println("=========");
		 System.out.println("TestCase : C33421");	
		 System.out.println("Page Rendering - Create Listing Must See");	
		 System.out.println("---------");		 
		...
		if (util.verifyLogin()) {
			 ...
			 try {
					assertEquals(clae.Verify_CL_MustSeeText(), true, "#Create Must See listing text must displayed");
					System.out.println("State : Create Must See listing text displayed as expected");
					
				} catch (Exception e){
							
					System.out.println("State : Create Must See listing text Not Shown as expected");
			 ...
			 try {
					assertEquals(clae.Verify_CL_BtSubmit(), true, "#Submit button must displayed");
