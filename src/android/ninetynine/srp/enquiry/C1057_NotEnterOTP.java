...
public class C1057_NotEnterOTP extends Base_Test {
	...
	@Test
	public void C1057_NotEnter_OTP() throws Exception {
			...
			srp = new SearchResultPage(driver);
			 ...
			 System.out.println("User Resend OTP");	
			 System.out.println("---------");		 
			wait_Long();	
			login.Click_Home_Me();
			...
			if (util.verifyLogin()) {
				...
				ldp.Click_CWA_BtEnquireNow();
				  ...
				  try {
						assertEquals(asl.Verify_ConfirmButton(), true, "#The confirm button should not be there");
						System.out.println("State : The system doesn't call");
						
					} catch (Exception e){
								
						System.out.println("State : The system calling as expected");
