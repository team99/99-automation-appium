...
public class C3_LoginVer_Shortlist extends Base_Test {
	...
	@Test
	public void C3_LoginVerShortlist() throws Exception {
		...
		srp = new SearchResultPage(driver);
		 ...
		 System.out.println("Login Ver - Shortlist");	
		 System.out.println("---------");		 
		wait_Long();	
		login.Click_Home_Me();
		...
		if (util.verifyLogin()) {
			 ...
			 login.Click_MeLogin();
			 login.Click_Login();
			 login.InputUsername(CONFIG.getProperty("Ver_Name"));
